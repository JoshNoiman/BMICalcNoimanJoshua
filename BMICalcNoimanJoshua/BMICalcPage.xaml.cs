        ...
        if (choice == "Male")
        {
            ...
            if (bmi > 30)
            {
                DisplayAlert("Your calculated BMI results are:", "Gender: " + choice + "\n" + "BMI:" + bmi.ToString() + "\n" +
                              ...
                              "Follow a structured weight-loss meal plan and consider behavioral therapy for lifestyle changes. Avoid sugary drinks and maintain a consistent sleep schedule ", "OK");
            }
        }
        if (choice == "Female")
        {
